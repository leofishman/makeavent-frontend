<template>
  <section class="group-steps">
    ...
    >
      ...
      <b-step-item
        step="1"
        :label="content.stepName.company"
                ...
                >
                  <section class="section">
                    <div class="content has-text-centered">
                      ...
                      <p>
                        {{ $root.content.groupPopupForm.validation.dropFile }}
                      </p>
                    </div>
                  </section>
                </b-upload>
      ...
      <b-step-item
        step="5"
        :label="content.stepName.preview"
        :clickable="isStepsClickable"
        disabled
      >
      ...
      <b-step-item
        step="6"
        :label="content.stepName.confirm"
        :clickable="isStepsClickable"
      >
        <h2 class="title last-step">{{ content.labels.confirm }}</h2>
        <div class="confirm-data">
          <div class="confirm-data__row">
            <div class="confirm-data__col-field">
              {{ content.confirmFields.company_name }}
            </div>
            <div
              contenteditable
              class="confirm-data__col-value"
              id="company_name"
              v-html="company_name"
              @blur="onEdit"
          ...
          <div class="confirm-data__row confirm-data__row--description">
            <div class="confirm-data__col-field">
              {{ content.confirmFields.company_description }}
            </div>
            <div
              contenteditable
              class="confirm-data__col-value"
      ...
      >
        <div class="group-steps__buttons">
          <b-button outlined type="is-danger" @click="close" v-if="firstStep">
  ...
  methods: {
    ...
    inputDate() {
      const elem = document.querySelector(
        ".group-steps .step-item .input-date"
      );
    ...
    async submit() {
      ...
      if (this.previewFile.name) {
        ...
        formatPreview = fileNamePreview.slice(
          fileNamePreview.lastIndexOf("."),
