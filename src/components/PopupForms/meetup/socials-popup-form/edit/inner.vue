<template>
    <section class="group-steps stuff-popup-form">
        <h2 class="title">{{$root.content.meetupSocialsPopupFrom.labels.title}}</h2>     <div class="socials-edit__add-item stuff-field">
            <b-field>
...
export default {
    ...
    async mounted(){        
        ...
        const newArray = this.$store.state.meetupForm.socials
    ...
    methods: {        
        ...mapActions(['getAllSocials', 'getMeetupById']),
        checkSubmit(val){
